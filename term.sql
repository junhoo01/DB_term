...
create table reviews(
  ...
  good numeric(3,0) not null,
  bad numeric(3,0) not null,
  primary key(mid, uid),
...
insert into reviews values
  ('1', 'admin', 4, 'An incredible movie. One that lives with you.', now()-interval'30day 1 hour 2 minute',0 ,0),
  ('1', 'andy', 5, 'the best movie in history and the best ending in any entertainment business', now()-interval'3 month 5 hour',0 ,0),
  ('2', 'admin', 5, 'What a Character-Study is Meant to Be.', now()-interval'34 day 34 hour',0 ,0),
  ('2', 'andy', 4, 'So Simple, So Brilliant', now()-interval'190hour 1 minute',0 ,0),
  ('3', 'admin', 5, 'In A Galaxy Far Away................A Franchise Was Born', now()-interval'3943hour 4 minute',0 ,0),
  ('3', 'andy', 5, 'The Force will be with you, always.', now()-interval'31 minute',0 ,0),
  ('4', 'admin', 4, 'Plastic Fantastic.', now()-interval'10 minute',0 ,0),
  ('4', 'andy', 5, 'It really is that good. It''s taken me 27 years to realise.', now()-interval'13 minute',0 ,0),
  ('5', 'admin', 5, 'Good Afternoon, Good Evening, and Goodnight.', now()-interval'30 hour',0 ,0),
  ('5', 'andy', 4, 'Incredibly surreal', now(),0 ,0),
  ('5', 'lisa', 4, 'The film is an amazing combination of existentialism, surrealism, and symbolism.', now(),0 ,0);
